Ext.define('ux.XCarousel', {
    ...
    onDragEnd: function (e) {
        ...
        if (flickDuration > 0 && Math.abs(flickDistance) >= 10) {
            ...
            if (Math.abs(velocity) >= 1) {
                if (velocity < 0 && activeIndex < maxIndex - displayCount + 1) {
        ...
        if (animationDirection === 0) {
            if (activeIndex < maxIndex - displayCount + 1 && offset < -threshold) {
                animationDirection = -1;
            }
    ...
    refreshSizing: function () {
        ...
        if (itemLength === null) {
            ...
            itemLength = this.getParent().element.getPageBox().width / displayCount;
            itemOffset = 0;
        }
    ...
    next: function () {
        ...
        if (this.activeIndex === this.getMaxItemIndex() - this.getDisplayCount() + 1) {
            return false;
        }
