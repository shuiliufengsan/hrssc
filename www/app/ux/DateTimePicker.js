Ext.define('ux.DateTimePicker', {
    ...
    updateValue: function(newValue) {
        ...
        if (this._picker && this._picker instanceof ux.DateTime) {
    ...
    updateDateFormat: function(newDateFormat, oldDateFormat) {
        ...
        if (newDateFormat != oldDateFormat && Ext.isDate(value) && this._picker && this._picker instanceof ux.DateTime) {
    ...
    getPicker: function() {
        ...
        if (picker && !picker.isPicker) {
            picker = Ext.factory(picker, ux.DateTime);
            picker.on({
                scope: this,
                cancel: 'onPickerHide',
