Ext.define('ChuangCai.view.supervise.BicycleMaintenanceAdd', {
    alternateClassName: 'bicycleMaintenanceAdd',
    extend: 'Ext.form.Panel',
    xtype: 'bicycleMaintenanceAdd',
