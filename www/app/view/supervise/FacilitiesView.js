Ext.define('ChuangCai.view.supervise.FacilitiesView', {
    alternateClassName: 'facilitiesView',
    extend: 'Ext.Container',
    xtype: 'facilitiesView',
    ...
    config: {
        ...
        listeners: {
            ...
            activate: function (newActiveItem, obj, oldActiveItem, eOpts) {
                var aRecord = Ext.Viewport.FacilitiesView.getRecord();
                if (aRecord == null) {
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function (result, context) {
                            ...
                            Ext.getCmp('facilitiesView').setHtml('<div class="i-panel-content">' + result.responseText + '</div>');
                            Ext.getCmp('facilitiesView').setScrollable(true);
