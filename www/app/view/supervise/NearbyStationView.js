Ext.define('ChuangCai.view.supervise.NearbyStationView', {
    alternateClassName: 'nearbyStationView',
    extend: 'Ext.Container',
    xtype: 'patrolView',
    requires: ['ux.plugin.ConHref', 'ChuangCai.view.panel.Img', 'Ext.form.FieldSet'],
    config: {
        cls: '',
        id: 'nearbyStationView',
        title: '详细内容',
        plugins: 'conHref',
        ...
        listeners: {
            activate: function (newActiveItem, obj, oldActiveItem, eOpts) {
                ...
                //});
                //}
                var aRecord = Ext.Viewport.NearbyStationView.getRecord();
                if (aRecord == null) {
                    util.showMessage1('空', true);
                }
                else {
                    ...
                    Ext.getCmp('nearbyStationView').setScrollable(true);
                }
            }
