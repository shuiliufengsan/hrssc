Ext.define('ChuangCai.view.supervise.PatrolTrackBrw', {
    alternateClassName: 'patrolTrackBrw',
    extend: 'ux.SimpleList',
    xtype: 'patrolTrackBrw',
    ...
    config: {
        ...
        items: [{
            ...
            {
                xtype: "button",
                id: "patrolTrackBrwProcessId",
                text: "处理中<span>(0)</span>",
                width: "33.3%",
                cls: "u-tab"
            }, {
                xtype: "button",
                id: "patrolTrackBrwCompleteId",
