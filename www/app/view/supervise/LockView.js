Ext.define('ChuangCai.view.supervise.LockView', {
    alternateClassName: 'lockView',
    ...
    config: {
        ...
        listeners: {
            ...
            activate: function (newActiveItem, obj, oldActiveItem, eOpts) {
                var aRecord = Ext.Viewport.LockView.getRecord();
                if (aRecord == null) {
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function (result, context) {
                            ...
                            Ext.getCmp('lockView').setHtml('<div class="i-panel-content">' + result.responseText + '</div>');
                            Ext.getCmp('lockView').setScrollable(true);
