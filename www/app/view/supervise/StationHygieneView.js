Ext.define('ChuangCai.view.supervise.StationHygieneView', {
    alternateClassName: 'stationHygieneView',
    extend: 'Ext.Container',
    xtype: 'stationHygieneView',
    requires: ['ux.plugin.ConHref', 'ChuangCai.view.panel.Img', 'Ext.form.FieldSet'],
    config: {
        cls: '',
        id: 'stationHygieneView',
        title: '详细内容',
        plugins: 'conHref',
        ...
        listeners: {
            ...
            activate: function (newActiveItem, obj, oldActiveItem, eOpts) {
                var aRecord = Ext.Viewport.StationHygieneView.getRecord();
                if (aRecord == null) {
