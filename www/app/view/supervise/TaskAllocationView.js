Ext.define('ChuangCai.view.supervise.TaskAllocationView', {
    alternateClassName: 'taskAllocationView',
    extend: 'Ext.Container',
    xtype: 'taskAllocationView',
    requires: ['ux.plugin.ConHref', 'ChuangCai.view.panel.Img', 'Ext.form.FieldSet'],
    config: {
        cls: '',
        id: 'taskAllocationView',
        title: '详细内容',
        plugins: 'conHref',
        ...
        listeners: {
            ...
            activate: function (newActiveItem, obj, oldActiveItem, eOpts) {
                var aRecord = Ext.Viewport.TaskAllocationView.getRecord();
                if (aRecord == null) {
