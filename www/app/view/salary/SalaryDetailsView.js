Ext.define('ChuangCai.view.salary.SalaryDetailsView', {
    alternateClassName: 'salarydetailsView',
    extend: 'Ext.Container',
    xtype: 'salarydetailsView',
    requires: ['ux.plugin.ConHref', 'ChuangCai.view.panel.Img', 'Ext.form.FieldSet'],
    config: {
        cls: 'info',
        id: 'salarydetailsView',
        title: '详细信息',
        plugins: 'conHref',
        //内容列表呈现
        items: [{
        ...
        listeners: {
            ...
            activate: function (newActiveItem, obj, oldActiveItem, eOpts) {
                var aRecord = Ext.Viewport.SalaryDetailsView.getRecord();
                if (aRecord == null) {
                    ...
                    Ext.getCmp('salarydetailsView').setScrollable(true);
                }
            }
