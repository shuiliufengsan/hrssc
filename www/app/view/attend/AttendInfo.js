Ext.define('ChuangCai.view.attend.AttendInfo', {
    alternateClassName: 'AttendInfo',
    ...
    config: {
        ...
        listeners: {
            activate: function (newActiveItem, obj, oldActiveItem, eOpts) {
                ...
                var attendingStore = new Ext.data.Store({
                    model: 'AttendingInfo',
                    proxy: {
                        type: "ajax",
                        url: util.getMobileSite() + 'HR/GetAttendingInfo.ashx?EmployeeId=' + util.getEmpId(),
                        reader: {
                            type: "json",
                            rootProperty: "result",
                ...
                Ext.getCmp("AttendInfoId").add(calendarPanel);
