Ext.define('ChuangCai.view.shop.ProductsDisplay', {
    alternateClassName: 'productsDisplay',
    //extend: 'ux.SimpleList',
    extend: 'Ext.DataView',
    xtype: 'productsDisplay',
